...
contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
    ...
    // Event emitted when  wnft token is minted
    event TokenMinted(
        uint256 tokenId, // The unique ID of the token.
        address newOwner // The address of the new owner of the token.
    );
    ...
    function burnAndSendNFT(
        ...
        //transfer WNFT to this addrress to burn the WNFT
    ...
    function _ccipReceive(
        ...
        //emit a event with the tokenId and newOwner
